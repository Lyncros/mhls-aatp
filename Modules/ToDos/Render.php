...
?>
<h1>Default To Dos</h1>

<div class="ButtonAdd" onClick="MToDos.Window_AddEdit(0);">Add</div>

<div style="position: absolute; right: 100px; top: 19px; line-height: 26px;">
	Show Inactive: <div class="ToggleOnOff <?=($ShowInactive ? "ToggleOn" : "ToggleOff");?>" onClick="CModule.Load('ToDos', {'ShowInactive' : '<?=((int)(!$ShowInactive));?>' });"></div>
</div>
...
<?
	function OnInfo($Value, $Row) {
		...
		$Content .= "<div style=\"float: right;\" class='Icon_Delete' title='Delete To Do' onClick=\"MToDos.Window_Delete(".$Row->ID.");\"></div>";
		$Content .= "<div style=\"float: right; margin-right: 4px;\" title='Edit To Do' class='Icon_Edit' onClick=\"MToDos.Window_AddEdit(".$Row->ID.");\"></div>";
