<?
	...
	*/
	//==========================================================================
	class MDocumentTemplates extends CModuleGeneric {
		function __construct() {
			$this->Table		= "DocumentTemplates";
			$this->Classname	= "CDocumentTemplates";
		...
		function OnExecute() {
			if(CSecurity::CanAccess($this->Name, "AddEdit")) {
				$this->Actions["New Document Template"] = Array("OnClick" => "MDocumentTemplates.Window_AddEdit(0);", "Icon" => "Icon_Popup");
			}
		...
		//----------------------------------------------------------------------
		function OnRenderJS() { 
			$this->FileControl->LoadFile("MDocumentTemplates.js", CFILE_TYPE_JS);
		}
