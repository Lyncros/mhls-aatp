...
class MAtomFeeds extends CModule {
    ...
    function OnAJAX($Action) {
        return Array(1, "Invalid ajax action $Action.");
    }
    ...
    private function Header() {
        return array(
            'Project Number', 'Project Value', 'District Manager', 'LSC', 'LSS',
            ...
            /* '2011 Sales Gross Units','2011 Sales Gross Revenue', */ 'Date Paid', 'ISBN-10', 'Spec Doc Link',
            /* 'Vendor','Custom ISBN', */ 'Connect Request ID link', 'Requested Budget', 'Plant Paid',
            'Plant Left', 'Milestones', 'Milestone Completion Percentage');
    }
    ...
    private function ProjectsInfo() {
        ...
        foreach ($this->GetProjects() as $Row) {
            ...
            $ProjectInfo[$col++] = $this->ParseDate($Project->CourseStartDate);
            $ProjectInfo[$col++] = $this->ParseDate($Project->DueDate);
            ...
            $ProjectInfo[$col++] = $this->ParseDate($Project->DatePaid);
            //30
            ...
            $ProjectInfo[$col++] = round($Project->GetMilestoneCompletionPercentage() * 100);
            //48
