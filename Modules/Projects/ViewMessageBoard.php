...
?>
	...
	<div class='Button' value='AddMessage' onClick="$('#AddMessage').slideDown();" style='float:left; position:relative; margin-left:0px; padding:0px 10px; margin-top:20px; margin-bottom:-38px; z-index:1000;'>Add New Message</div>
