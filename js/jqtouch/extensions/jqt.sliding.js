/**
 * 
 * Add support for slideing horizontally and vertically using jQTouch in Safari Mobile
 *
 ...
 *
 *		    .horizontal-scroll, .horizontal-scroll .scroll-container, .horizontal-slide, .horizontal-slide .slide-container
            {
            	width:320px;
                height:100%;
                overflow:hidden;
            ...
            .landscape .horizontal-scroll, .landscape .horizontal-scroll .scroll-container, .landscape .horizontal-slide, .landscape .horizontal-slide .slide-container
            {
                width: 320px;
            }
            .portrait .horizontal-scroll, .portrait .horizontal-scroll .scroll-container, .portrait .horizontal-slide, .portrait .horizontal-slide .slide-container
            {
                width: 480px;
            }
            ...
            .vertical-scroll > div > div, .vertical-slide > div > div
            {
            	height:400px;
            }
 *
 *     Insert html with the following structure:
 *
					...
					for (l = elements.length; i < l; ++i)
					{
						...
						if (elements[i].offsetTop >= opposite)
						{
							return !dir
									...
									: -elements[i].previousSibling.offsetTop;
						}
					}
				}
					...
					for (; i < l; ++i)
					{
						if (elements[i].offsetLeft >= opposite)
						{
							return !dir
									...
									: -elements[i].previousSibling.offsetLeft;
						}
					}
				}
