/*
    ...
    $Revision: 118 $
    $Date: 2009-10-30 23:36:18 -0400 (Fri, 30 Oct 2009) $
    ...
    $.jQTouch = function(options) {
        ...
        // PUBLIC FUNCTIONS
		 function goForward(to) {
            // Init the param
                var numberOfPages = Math.min(parseInt(to || 0, 10), forward.length-1),
                    curPage = hist[0], toPage, animation;
                ...
                if (forward.length > 0)
                {
                    ...
                    animatePages(curPage.page, hist[0].page, hist[0].animation, !!curPage.reverse);
                }
                else
                {
        ...
        function goBack(to, returnTravel) {
            // Init the param
                ...
                {
                    // Remove all pages in front of the target page
                    travel = hist.splice(0, numberOfPages);
        ...
        function hashCheck() {
            ...
            if (location.hash == '') {
				...
				//added
				var i = 0, l = forward.length, h = location.hash;
				for (;i < l; ++i)
				{
					if ('#' + forward[i].id == h)
					{
                ...
                forward.unshift.apply(forward, goBack(h, true));
            }
        }
